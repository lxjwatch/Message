package com.message.austin.web.aspect;

import cn.hutool.core.util.IdUtil;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.common.collect.Lists;
import com.message.austin.web.vo.RequestLogDTO;
...
public class AustinAspect {
     ...
     * 只切AustinAspect注解
     */
    @Pointcut("@within(com.message.austin.web.annotation.AustinAspect) || @annotation(com.message.austin.web.annotation.AustinAspect)")
