package com.message.austin.handler.config;


import com.message.austin.common.pipeline.ProcessController;
import com.message.austin.common.pipeline.ProcessTemplate;
import com.message.austin.handler.action.DeduplicationAction;
import com.message.austin.handler.action.DiscardAction;
import com.message.austin.handler.action.SendMessageAction;
import com.message.austin.handler.action.ShieldAction;
